...
public class EditView extends View {
    ...
    protected void createElements() {
        ...
        Button enterStudent = new Button(parent,
                new BaseElement.Rectangle(widthUnitSize, heightUnitSize * 4.5f, widthUnitSize * 27 / 10, heightUnitSize * 2),
        ...
        Button removeStudent = new Button(parent,
                new BaseElement.Rectangle(widthUnitSize * 4f, heightUnitSize * 4.5f, widthUnitSize, heightUnitSize * 2),
        ...
        Button selectFile = new Button(parent,
                new BaseElement.Rectangle(widthUnitSize, heightUnitSize * 10.5f, widthUnitSize * 4, heightUnitSize * 2),
        ...
        Button back = new Button(parent,
                new BaseElement.Rectangle(widthUnitSize, heightUnitSize * 13.5f, widthUnitSize * 2, heightUnitSize),
                3, "Volver atrás", true);
        ...
        Button addToList = new Button(parent,
                new BaseElement.Rectangle(widthUnitSize * 7f, heightUnitSize * 2f, widthUnitSize * 2, heightUnitSize),
        ...
        Button deleteFromList = new Button(parent,
                new BaseElement.Rectangle(widthUnitSize * 10f, heightUnitSize * 2f, widthUnitSize * 2, heightUnitSize),
        ...
        Button emptyList = new Button(parent,
                new BaseElement.Rectangle(widthUnitSize * 13f, heightUnitSize * 2f, widthUnitSize * 2, heightUnitSize),
        ...
        TextField manuallyTF = new TextField(parent,
                new BaseElement.Rectangle(widthUnitSize, heightUnitSize * 1.5f, widthUnitSize * 3, heightUnitSize),
                "Manualmente:", "");
        ...
        TextField idTF = new TextField(parent,
                new BaseElement.Rectangle(widthUnitSize, heightUnitSize * 3f, widthUnitSize * 3 / 2, heightUnitSize),
                "", "ID");
        ...
        TextField emailTF = new TextField(parent,
                new BaseElement.Rectangle(widthUnitSize * 3f, heightUnitSize * 3f, widthUnitSize * 2, heightUnitSize),
                "", "email");
        ...
        TextField auxStudentsCounter = new TextField(parent,
                new BaseElement.Rectangle(widthUnitSize * 7f, heightUnitSize * 14f, widthUnitSize * 3, heightUnitSize),
        ...
        TextField dbStudentsCounter = new TextField(parent,
                new BaseElement.Rectangle(widthUnitSize * 12f, heightUnitSize * 14f, widthUnitSize * 3, heightUnitSize),
                "Alumnos en BD: 0", "");
        dbStudentsCounter.setFont(fontSmall);
        elements.put("dbStudentsTF", dbStudentsCounter);

        TextField inputFile = new TextField(parent,
                new BaseElement.Rectangle(widthUnitSize, heightUnitSize * 9f, widthUnitSize * 4, heightUnitSize),
                "", "Archivo de texto");
        ...
        ItemList auxStudentsItemList = new ItemList(parent,
                new BaseElement.Rectangle(widthUnitSize * 7f, heightUnitSize * 4f, widthUnitSize * 3, heightUnitSize * 10),
                "Lista temporal");
        ...
        ItemList dbStudentsItemList = new ItemList(parent,
                new BaseElement.Rectangle(widthUnitSize * 12f, heightUnitSize * 4f, widthUnitSize * 3, heightUnitSize * 10),
                "Alumnos en BD");
        ...
        ModalCard modalCard = new ModalCard(parent, new BaseElement.Rectangle(0, 0, widthUnitSize * 16, heightUnitSize * 16), modal);
        modalCard.setVisible(false);
        elementsOverModal.put("modalCard", modalCard);

        Button confirmEmpty = new Button(parent,
                new BaseElement.Rectangle(widthUnitSize * 4f, heightUnitSize * 4f, widthUnitSize * 8, heightUnitSize * 6),
        ...
        Button exitModal = new Button(parent,
                new BaseElement.Rectangle(widthUnitSize * 6f, heightUnitSize * 11f, widthUnitSize * 4, heightUnitSize * 2),
                3, "Cancelar", false);
