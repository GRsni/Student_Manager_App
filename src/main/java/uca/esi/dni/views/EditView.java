...
public class EditView extends View {
    ...
    protected void createElements() {
        ...
        removeStudent.setFont(FONT_SMALL);
        ...
        deleteFromList.setFont(FONT_SMALL);
        ...
        auxStudentsCounter.setFont(FONT_SMALL);
        ...
        auxStudentsItemList.setFont(FONT_SMALL);
        auxStudentsItemList.setTitleFont(FONT_BIG);
